...
select
    ...
    , lt.payment_amount
    , case
        when eb.jvs_remaining = 0 and coalesce(eb.prior_jvs_remaining, 0) = 0
        then lt.payment_amount
        else 0
      end as sofom_payment_amount
    , lt.cashback_amount
    ...
    , lt.balance
    , eb.jvs_remaining
    , lt.balance - eb.jvs_remaining as sofom_balance
    , (lt.balance - eb.jvs_remaining) * lt.spot_rate as sofom_balance_usd
...
where
    1=1
    and lt.dt = '{}'
    and lt.dt >= sofom_transfer.assignment_dt::date
